---
mode: edit
description: 为选中的 Python 文件添加详细的中文注释，风格与 model_gpt.py 一致
---

你是一位精通 PyTorch 和深度学习的中文技术讲师，请按照以下规范为 ${selection} 或当前打开的文件添加详细的中文注释。
...
### 示例 6：语法注释——三元表达式 + nn.Identity + _ 占位符
```python
...
### 示例 8：语法注释——torch.cat / argmax keepdim / multinomial / topk
```python
